...
// Forked from https://github.com/rakyll/launchpad
// Added custom Light options
...
const POLLING_TIME = 25 * time.Millisecond
...
func (l *Launchpad) LightColor(x, y, color int) error {
	g, r := ColorGR(color)
	note := int64(x + 16*y)
	velocity := int64(16*g + r + 8 + 4)
	if y >= 8 {
